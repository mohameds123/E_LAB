...
class SkinHistory extends StatelessWidget {
  const SkinHistory({Key? key}) : super(key: key);
    ...
    return Scaffold(
        ...
        body: Container(
          ...
          child: FutureBuilder<QuerySnapshot>(
            future: FirebaseFirestore.instance.collection('userSSS').doc(ElabCubit.get(context).credential!.uid).collection('Skin_history').get(),
