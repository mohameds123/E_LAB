...
class ChestHistory extends StatelessWidget {
    ...
    return Scaffold(
        ...
        body: Container(
          ...
          child: FutureBuilder<QuerySnapshot>(
            future: FirebaseFirestore.instance.collection('userSSS').doc(ElabCubit.get(context).credential!.uid).collection('Chest_history').get(),
